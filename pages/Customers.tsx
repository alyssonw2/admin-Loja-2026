...
const Customers: React.FC<CustomersProps> = ({ customers, onViewProfile }) => {
  return (
    <div className="p-8">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Clientes</h2>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody>
            {customers.length === 0 ? (
               <tr>
                  <td colSpan={5} className="text-center p-8 text-gray-500 dark:text-gray-400">Nenhum cliente encontrado.</td>
                </tr>
              ...
              <tr key={customer.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                ...
                <td className="p-4 text-gray-900 dark:text-white">R$ {customer.totalSpent.toFixed(2)}</td>
                <td className="p-4">
