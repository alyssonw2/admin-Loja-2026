  ...
  return (
    <div className="p-8 space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <DashboardCard title="Novos Pedidos" value={kpi.newOrders} icon={NewOrderIcon} color="bg-orange-500" />
        <DashboardCard title="Total de Clientes" value={kpi.totalCustomers} icon={CustomerIcon} color="bg-yellow-500" />
        <DashboardCard title="Envios Pendentes" value={kpi.pendingShipments} icon={ShipmentIcon} color="bg-orange-500" />
      </div>
