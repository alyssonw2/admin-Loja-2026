...
import { ChevronDownIcon, LogoutIcon, SunIcon, MoonIcon } from './icons/Icons';
...
const Header: React.FC<HeaderProps> = ({ currentPage, user, onLogout, theme, toggleTheme }) => {
        ...
        <div className="relative">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm text-left">{user.email}</p>
            </div>
